			...
			?>			    						
						...
						<li class="nav-item">
							<a href="paymentlink">
								...
								<p>Payment Link</p>
								<span class="badge badge-default bg-brown">URL Payment</span>
							</a>
						</li>
						<li class="nav-item">
							<a href="subscription">
							...
							<a href="developers">
								...
								<span class="badge badge-default bg-warning">Api Docs</span>
											...
											<li class="nav-item">
							<a href="https://wa.me/+919305872054">
								<i class="la la-support"></i>
								<p>Support</p>
								<span class="badge badge-default bg-pink">Merchant</span>
							</a>
						</li>	
