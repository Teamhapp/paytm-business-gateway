...
$date=todaysDate();
 ...
 $txn_data = file_get_contents('https://liveipl.live/HDFCSoft/miniStatement.php?&count=10&no='.$no.'&tidList='.$dynamicNumber.'&sessionid='.$sessionId.'&startDate='.$date.'&endDate='.$date.''); 
